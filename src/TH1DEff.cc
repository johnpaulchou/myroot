...
Bool_t TH1DEff::Add(TF1* h1, Double_t c1, Option_t* option)
{
  Warning("Add","This will simply do a linear add.  Are you sure this is what you want to do?");
  return TH1::Add(h1, c1, option);
}

Bool_t TH1DEff::Add(const TH1* h1, Double_t c1)
{
  if (!h1) {
...
Bool_t TH1DEff::Add(const TH1* h1, const TH1* h2, Double_t c1, Double_t c2)
{
  if (!h1 || !h2) {
    Error("Add","Attempt to add a non-existing histogram");
    return kFALSE;
...
Bool_t TH3DEff::Add(TF1* h1, Double_t c1, Option_t* option)
{
  Warning("Add","This will simply do a linear add.  Are you sure this is what you want to do?");
  return TH1::Add(h1, c1, option);
}

Bool_t TH3DEff::Add(const TH1* h1, Double_t c1)
{
  if (!h1) {
    Error("Add","Attempt to add a non-existing histogram");
    return kFALSE;
...
Bool_t TH3DEff::Add(const TH1* h1, const TH1* h2, Double_t c1, Double_t c2)
{
  if (!h1 || !h2) {
    Error("Add","Attempt to add a non-existing histogram");
    return kFALSE;
